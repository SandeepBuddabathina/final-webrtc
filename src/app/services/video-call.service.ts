...
//   constructor(private faceService: FaceExpressionService,private http: HttpClient) {
...
//   this.http.get<{ roomId: string }>('http://localhost:3000/generate-room').subscribe(response => {
